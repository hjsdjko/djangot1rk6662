...
<div class="home-preview" :style='{"margin":"0px auto","flexWrap":"wrap","flexDirection":"column","background":"none","display":"flex","width":"100%","justifyContent":"center"}'>
	...
	<div id="animate_newsnews" class="news animate__animated" :style='{"padding":"0","margin":"0 0 10px","background":"url(),#fff","order":"5"}'>
		...
		<div class="title" :style='{"width":"100%","margin":"40px auto 10px","lineHeight":"50px","textAlign":"center","background":"none"}'>
			<span :style='{"color":"#333","fontSize":"32px","lineHeight":"40px"}'>公告</span>
		</div>
...
<!-- 特价商品 -->
<div id="animate_listkechengxinxi" class="lists animate__animated" :style='{"margin":"30px 0 20px","background":"#fff","order":"1"}'>
	...
	<div class="title" :style='{"width":"100%","margin":"10px auto","lineHeight":"40px","textAlign":"center","background":"none"}'>
	  <span :style='{"fontSize":"32px","lineHeight":"40px","color":"#333","font":"\"宋体\""}'>课程信息展示</span>
	</div>
	...
	<div v-if="kechengxinxiList.length" class="list list12 index-pv1 list12kechengxinxi" :style='{"width":"100%","padding":"10px 7%","background":"#fff","height":"auto"}'>
	  <div class="list" :style='{"margin":"40px 0 0","overflow":"hidden","flexWrap":"wrap","flex":"1","background":"#fff","display":"flex","justifyContent":"space-between","height":"auto"}'>
	    <div :style='{"cursor":"pointer","width":"23%","margin":"0 0 30px","position":"relative","height":"auto"}' class="item list-item animation-box" v-for="item,index in kechengxinxiList" :key="index" @click="toDetail('kechengxinxiDetail', item)">
			...
			<div class="line1" :style='{"padding":"0 10px","overflow":"hidden","whiteSpace":"nowrap","color":"#333","width":"100%","lineHeight":"32px","fontSize":"16px","textOverflow":"ellipsis"}'>{{item.kechengmingcheng}}</div>
			<div class="line1" :style='{"padding":"0 10px","overflow":"hidden","whiteSpace":"nowrap","color":"#333","width":"100%","lineHeight":"32px","fontSize":"16px","textOverflow":"ellipsis"}'>{{item.shangkedidian}}</div>
			<div class="line1" :style='{"padding":"0 10px","overflow":"hidden","whiteSpace":"nowrap","color":"#333","width":"100%","lineHeight":"32px","fontSize":"16px","textOverflow":"ellipsis"}'>{{item.jiaoshixingming}}</div>
	    </div>
	  </div>
	</div>
	...
	<div @click="moreBtn('kechengxinxi')" :style='{"border":"1px solid #ddd","cursor":"pointer","margin":"30px auto 10px","textAlign":"center","background":"#fff","display":"block","width":"120px","lineHeight":"36px"}'>
		<span :style='{"color":"#333","fontSize":"14px"}'>查看更多</span>
...
<!-- 特价商品 -->
	...
	<!-- 友链 -->
	<div id="friendly" class="friendly animate__animated" :style='{"padding":"0px 7%","margin":"0px auto 0","borderColor":"#ededed","background":"#fcfcfc","borderWidth":"1px 0 0","width":"100%","borderStyle":"solid","height":"auto","order":"12"}'>
	  <div :style='{"borderColor":"#ddd","margin":"20px auto 0","textAlign":"center","borderWidth":"0 0 0px","width":"100%","borderStyle":"solid","height":"auto"}'>
	    <div :style='{"padding":"0 10px","borderColor":"rgba(64, 158, 255)","margin":"0 0 -1px 0","color":"#333","borderWidth":"0 0 0px","display":"inline-block","lineHeight":"60px","fontSize":"32px","borderStyle":"solid"}'>合作客户</div>
	  </div>
	  <div :style='{"width":"100%","padding":"10px 0","flexWrap":"wrap","justifyContent":"center","display":"flex","height":"auto"}'>
	    <div :style='{"cursor":"pointer","margin":"0 2% 20px 0","alignItems":"center","flexDirection":"column","display":"flex","width":"auto","justifyContent":"center","height":"auto"}' v-for="item in friendLinkList" :key="item.id" @click="friendlinkClick(item.url)">
	      <img :style='{"border":"1px solid #ddd","padding":"10px","margin":"0 auto","objectFit":"contain","borderRadius":"0px","background":"#fff","display":"block","width":"auto","height":"120px"}' :src="item.picture?(baseUrl + item.picture.split(',')[0]): ''" alt="">
	      <div :style='{"overflow":"hidden","whiteSpace":"nowrap","color":"#333","textAlign":"center","width":"100%","lineHeight":"30px","fontSize":"14px","textOverflow":"ellipsis"}'>{{item.name}}</div>
	    </div>
	  </div>
	</div>
	<!-- 友链 -->
    ...
    methods: {
		...
		handleScroll() {
			let arr = [
				...
				{id:'animate_listkechengxinxi',css:'animate__fadeInLeft'},
      ...
      getSystemIntroduction() {
		...
		getList() {
			...
			this.$http.get('kechengxinxi/list', {params: data}).then(res => {
				if (res.data.code == 0) {
