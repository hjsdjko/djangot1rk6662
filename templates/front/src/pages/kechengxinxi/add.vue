...
<div :style='{"width":"100%","padding":"30px 7% 40px","margin":"0px auto","position":"relative","background":"#fff"}'>
    ...
    >
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="学分" prop="xuefen">
            <el-input v-model.number="ruleForm.xuefen" 
                placeholder="学分" clearable :disabled=" false  ||ro.xuefen"></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="上课教师" prop="jiaoshixingming">
            <el-input v-model="ruleForm.jiaoshixingming" 
                placeholder="上课教师" clearable :disabled=" false  ||ro.jiaoshixingming"></el-input>
          </el-form-item>
