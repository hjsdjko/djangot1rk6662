...
<div class="content" :style='{"minHeight":"100vh","padding":"30px 30px 20px","alignItems":"flex-start","flexWrap":"wrap","background":"url() no-repeat center top / cover,#fff","display":"flex","width":"100%","fontSize":"14px","height":"auto"}'>
	...
	<div :style='{"border":"0px solid #e3e3e3","padding":"0","margin":"0 0 10px","alignItems":"center","color":"#5daced","display":"block","justifyContent":"space-between","borderRadius":"5px","flexWrap":"wrap","background":"#fff","width":"100%","fontSize":"14px","order":"0"}'>
		<div :style='{"padding":"16px 10px","margin":"0 2% 26px 0","borderColor":"#e3e3e3","alignItems":"center","textAlign":"center","display":"flex","float":"left","justifyContent":"center","borderRadius":"5px","background":"#f7f7f7","borderWidth":"1px","width":"31%","borderStyle":"solid"}' v-if="isAuth('xuesheng','首页总数')">
			...
			<div :style='{"width":"auto","margin":"0 0 0 20px","textAlign":"center","flexDirection":"column","justifyContent":"center","display":"flex"}'>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"36px","color":"#6bccc9","fontWeight":"600","height":"24px"}'>{{xueshengCount}}</div>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"14px","color":"#666","height":"24px"}'>学生总数</div>
			</div>
		</div>
		<div :style='{"padding":"16px 10px","margin":"0 2% 26px 0","borderColor":"#e3e3e3","alignItems":"center","textAlign":"center","display":"flex","float":"left","justifyContent":"center","borderRadius":"5px","background":"#f7f7f7","borderWidth":"1px","width":"31%","borderStyle":"solid"}' v-if="isAuth('kechengchengji','首页总数')">
			...
			<div :style='{"width":"auto","margin":"0 0 0 20px","textAlign":"center","flexDirection":"column","justifyContent":"center","display":"flex"}'>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"36px","color":"#fc6c60","fontWeight":"600","height":"24px"}'>{{kechengchengjiCount}}</div>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"14px","color":"#666","height":"24px"}'>课程成绩总数</div>
			</div>
		</div>
		<div :style='{"padding":"16px 10px","margin":"0 2% 26px 0","borderColor":"#e3e3e3","alignItems":"center","textAlign":"center","display":"flex","float":"left","justifyContent":"center","borderRadius":"5px","background":"#f7f7f7","borderWidth":"1px","width":"32%","borderStyle":"solid"}' v-if="isAuth('banji','首页总数')">
			<div :style='{"alignItems":"center","borderRadius":"100%","background":"#f6d346","display":"flex","width":"50px","justifyContent":"center","height":"50px"}'>
				<span class="icon iconfont icon-chujia3" :style='{"color":"#fff","fontSize":"32px"}'></span>
			</div>
			<div :style='{"width":"auto","margin":"0 0 0 20px","textAlign":"center","flexDirection":"column","justifyContent":"center","display":"flex"}'>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"36px","color":"#f6d346","fontWeight":"600","height":"24px"}'>{{banjiCount}}</div>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"14px","color":"#666","height":"24px"}'>班级总数</div>
			</div>
		</div>
	</div>
	<!-- statis -->
	...
	<div class="type3" :style='{"alignContent":"flex-start","padding":"0","borderRadius":"8px","flexWrap":"wrap","background":"none","display":"flex","width":"100%","position":"relative","justifyContent":"space-between","height":"auto","order":"10"}'>
		<div id="kechengchengjiChart1" class="echarts1" v-if="isAuth('kechengchengji','首页统计')"></div>
		<div id="kechengchengjiChart2" class="echarts2" v-if="isAuth('kechengchengji','首页统计')"></div>
