<template>
  <div :style='{"color":"#3B3E40","padding":"30px 30px 30px","fontSize":"14px"}'>
    <el-form
      ...
      label-width="180px"
    >
      <el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 16px 0","color":"inherit","borderRadius":"0px","background":"none","width":"100%","fontSize":"inherit"}' label="选择试卷" prop="paperid">
      ...
      <el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 16px 0","color":"inherit","borderRadius":"0px","background":"none","width":"100%","fontSize":"inherit"}' label="试题" prop="questionname">
        <el-input
          type="textarea"
          min="1"
      ...
      <el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 16px 0","color":"inherit","borderRadius":"0px","background":"none","width":"100%","fontSize":"inherit"}' label="类型" prop="type">
      ...
      <el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 16px 0","color":"inherit","borderRadius":"0px","background":"none","width":"100%","fontSize":"inherit"}' v-if="ruleForm.type!=3&&ruleForm.type!=2&&ruleForm.type!=4" label="选项" prop="options">
      ...
      <el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 16px 0","color":"inherit","borderRadius":"0px","background":"none","width":"100%","fontSize":"inherit"}' v-if="ruleForm.type==0 && options.length>0" label="答案" prop="answer">
      ...
      <el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 16px 0","color":"inherit","borderRadius":"0px","background":"none","width":"100%","fontSize":"inherit"}' v-if="ruleForm.type==1 && options.length>0" label="答案" prop="answer">
      ...
      <el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 16px 0","color":"inherit","borderRadius":"0px","background":"none","width":"100%","fontSize":"inherit"}' v-if="ruleForm.type==2 && options.length>0" label="答案" prop="answer">
        <el-select v-model="ruleForm.answer" @change="answerChange">
          <el-option
            :label="item.text"
            :value="item.code"
      ...
      <el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 16px 0","color":"inherit","borderRadius":"0px","background":"none","width":"100%","fontSize":"inherit"}' v-if="ruleForm.type==3" label="答案" prop="answer">
        <el-input v-model="ruleForm.answer" placeholder="答案" clearable @input="answerChange"></el-input>
      </el-form-item>
      <el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 16px 0","color":"inherit","borderRadius":"0px","background":"none","width":"100%","fontSize":"inherit"}' label="分数" prop="score">
        <el-input-number v-model="ruleForm.score" :min="1" :max="100" label="分数"></el-input-number>
      </el-form-item>
      <el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 16px 0","color":"inherit","borderRadius":"0px","background":"none","width":"100%","fontSize":"inherit"}' label="分析" prop="analysis">
        <el-input
          type="textarea"
          min="1"
      ...
      <el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 16px 0","color":"inherit","borderRadius":"0px","background":"none","width":"100%","fontSize":"inherit"}' label="排序" prop="sequence">
      ...
      <el-form-item :style='{"padding":"10px 0 20px","margin":"30px 0","alignItems":"center","textAlign":"center","background":"none","display":"flex","width":"calc(100% - 150px)","perspective":"320px","-webkitPerspective":"320px","fontSize":"48px","justifyContent":"center"}'>
		<el-button class="btn3" :style='{"border":"1px solid #0f70ad","cursor":"pointer","padding":"0 20px","boxShadow":"inset 0 1px 0 rgba(255, 255, 255, 0.2)","margin":"0px 10px","color":"#fff","minWidth":"78px","transition":"all 0.3s","borderRadius":"3px","background":"linear-gradient(to bottom, #208ed3 0%,#0272bd 100%)","width":"auto","fontSize":"14px","lineHeight":"24px","textShadow":"1px 1px 0 rgba(0, 0, 0, 0.2)","height":"44px"}' type="success" @click="onSubmit">
			<span class="icon iconfont icon-tijiao16" :style='{"margin":"0 2px","fontSize":"18px","color":"inherit","display":"inline-block"}'></span>
			确定
		</el-button>
		<el-button class="btn4" :style='{"border":"1px solid #af2b1b","cursor":"pointer","padding":"0 20px","boxShadow":"inset 0 1px 0 rgba(255, 255, 255, 0.2)","margin":"0px 10px","color":"#fff","minWidth":"78px","transition":"all 0.3s","borderRadius":"3px","background":"linear-gradient(to bottom, #bc3423 0%,#cd4433 100%)","width":"auto","fontSize":"14px","lineHeight":"24px","textShadow":"1px 1px 0 rgba(0, 0, 0, 0.4)","height":"44px"}' type="success" @click="back()">
